...
HD_PWD='/home/jayd/ultra96_demo/ultra96_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arbiter_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arbiter_tb.tcl -notrace
