...
HD_PWD='/home/jayd/u96_4bitcounter/u96_4bitcounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log first_counter_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source first_counter_tb.tcl
